...
<head>
    ...
    <script type="text/javascript">
        function addDialog() {
            ...
            newdish=window.showModalDialog("dish.jsp","",paramers);
...
<main role="main" class="container">
    <div class="container">
       <form>
           <input type="text" id="addDish" onclick="addDialog()">
       </form>
    </div>
                            ...
                            <form name="sendid" method="post" action="chooseFood">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <input type=submit class="btn btn-sm btn-outline-secondary" value="View" ></input>
                                            <button type="button" class="btn btn-sm btn-outline-secondary "onclick="window.location.href='/chooseFood?stid=${store.getStId()}'">Edit</button>
                                        </div>
